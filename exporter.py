...
def build_pdf_report(
    ...
    # ── Header ────────────────────────────────────────────────────────────────
    story.append(Paragraph("PlainLaw", styles["title"]))
    ...
    story.append(Paragraph(
        "Generated by PlainLaw · This report is for informational purposes only and does not constitute legal advice. "
